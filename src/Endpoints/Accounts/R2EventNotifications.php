...
class R2EventNotifications extends AbstractEndpoint
{
    /**
     ...
     */
    public function details(string $accountId, string $bucketName, string $queueId, ?string $jurisdiction = null): ResponseInterface
    {
