...
<params-table :params="[{"name":"values","type":"array","required":true,"description":"Token values, requires name and policies."}]">
...
<params-table :params="[{"name":"tokenId","type":"string","required":true,"description":"Token identifier."}]">
...
<params-table :params="[{"name":"tokenId","type":"string","required":true,"description":"Token identifier."},{"name":"values","type":"array","required":true,"description":"Token values, e.g. name, policies, condition, status."}]">
