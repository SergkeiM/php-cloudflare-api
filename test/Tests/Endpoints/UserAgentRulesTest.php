...
class UserAgentRulesTest extends TestCase
{
    ...
    public function shouldListRules()
    {
        ...
        $response = $client->userAgentRules()->list('zone_id', ['paused' => 'false', 'per_page' => 20]);
    ...
    public function shouldCreateRule()
    {
        ...
        $response = $client->userAgentRules()->create('zone_id', $values);
    ...
    public function shouldThrowWhenCreatingWithoutModeOrConfiguration()
    {
        ...
        $client->userAgentRules()->create('zone_id', ['description' => 'no mode here']);
    }
    ...
    public function shouldThrowWhenUpdatingWithoutModeOrConfiguration()
    {
        ...
        $client->userAgentRules()->update('zone_id', 'rule_id', ['paused' => true]);
    }
