...
class RoutesTest extends TestCase
{
    ...
    public function shouldGetByIpWithoutVirtualNetwork()
    {
        ...
        $response = $client->zeroTrust()->networks()->routes()->getByIP('account_id', '127.0.0.1');
    ...
    public function shouldGetByIpWithVirtualNetwork()
    {
        ...
        $response = $client->zeroTrust()->networks()->routes()->getByIP('account_id', '127.0.0.1', 'vnet_id');
    ...
    public function shouldUpdate()
    {
        ...
        $response = $client->zeroTrust()->networks()->routes()->edit('account_id', 'route_id', ['comment' => 'updated']);
