---
title: Filters
description: "Filters endpoint reference."
navigation:
    title: Filters
---
...
params:
  ...
  - name: "filters"
    type: "array"
    required: true
    description: "Array of filter definitions, e.g. `[['expression' => 'ip.src eq 127.0.0.1']]`."
---
::
...
params:
  ...
  - name: "values"
    type: "array"
    required: true
    description: "Values to set on the filter."
---
::
