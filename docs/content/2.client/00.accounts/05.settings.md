---
title: Settings
description: "Account-wide settings, as opposed to the per-zone toggles under `$client->zones()->settings()`."
navigation:
    title: Settings
---
...
params:
  ...
  - name: "values"
    type: "array"
    required: false
    description: "Setting value, `['value' => 'on']`."
    default: "array ( 'value' => 'on', )"
---
::
