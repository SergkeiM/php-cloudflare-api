...
description: "Resource Groups endpoint reference."
navigation:
    title: Resource Groups
---
...
params:
  ...
  - name: "params"
    type: "array"
    required: false
    description: "Array containing the necessary params, e.g. id, name."
    default: "[]"
---
::
...
params:
  ...
  - name: "values"
    type: "array"
    required: true
    description: "Resource Group values, requires name and scope."
---
::
...
params:
  ...
  - name: "values"
    type: "array"
    required: false
    description: "Resource Group values, e.g. name, scope."
    default: "[]"
---
::
