---
title: Buckets
description: "Buckets endpoint reference."
navigation:
    title: Buckets
---
...
params:
  ...
  - name: "values"
    type: "array"
    required: true
    description: "Values to set on the bucket, e.g. `name`, `locationHint`, `storageClass`."
  - name: "jurisdiction"
    type: "string|null"
    required: false
    description: "Jurisdiction where objects in this bucket are guaranteed to be stored."
...
params:
  ...
  - name: "storageClass"
    type: "string"
    required: true
    description: "Storage class to set on the bucket, e.g. `Standard` or `InfrequentAccess`."
  - name: "jurisdiction"
    type: "string|null"
    required: false
    description: "Jurisdiction where objects in this bucket are guaranteed to be stored."
...
params:
  ...
  - name: "values"
    type: "array"
    required: true
    description: "Values to set, e.g. `bucket`, `permission`, `ttlSeconds`, `parentAccessKeyId`."
---
::
