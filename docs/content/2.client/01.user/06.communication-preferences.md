...
description: "What Cloudflare is allowed to email the authenticated user about, and in which language."
navigation:
    title: Communication Preferences
---
...
params:
  - name: "values"
    type: "array"
    required: true
    description: "`preferences`, a map of preference key to subscription state, and `language-locale`, one of `en-US`, `es-ES`, `de-DE`, `fr-FR`, `it-IT`, `ja-JP`, `ko-KR`, `pt-BR`, `zh-CN` or `zh-TW`. Omitting the locale leaves it unchanged."
---
::
