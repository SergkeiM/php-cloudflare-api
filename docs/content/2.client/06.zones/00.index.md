...
params:
  ...
  - name: "values"
    type: "array"
    required: true
    description: "`name`, the domain name, is required. `type` is `full` when Cloudflare hosts the DNS, or `partial` for a partner-hosted or CNAME setup."
---
::
...
params:
  ...
  - name: "values"
    type: "array"
    required: true
    description: "Any of `type` (`full` or `partial`, Enterprise-only unless enabled on the zone), `vanity_name_servers` (Business and Enterprise plans), `paused` and `plan`."
---
::
...
params:
  - name: "zoneId"
    ...
    description: "Zone Identifier."
  - name: "purgeBy"
    type: "CachePurge|array"
    required: true
    configuration: "/advanced/configurations/zones/cache-purge"
---
::
