---
title: Phases
description: "Each phase of the Ruleset Engine runs one entry point ruleset, which is where your own rules for that phase live — `http_request_firewall_custom` for custom firewall rules, `http_request_transform` for URL rewrites, and so on."
navigation:
    title: Phases
---
...
params:
  ...
  - name: "phase"
    type: "string"
    required: true
    description: "The phase of the ruleset, e.g. `http_request_firewall_custom`."
---
::
...
params:
  ...
  - name: "values"
    type: "Ruleset|array"
    required: true
    configuration: "/advanced/configurations/ruleset"
