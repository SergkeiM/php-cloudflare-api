...
params:
  ...
  - name: "modes"
    type: "array"
    required: true
    description: "TLS compliance modes constraining the key-exchange algorithms Cloudflare offers the origin, e.g. `['fips', 'pqh']`."
---
::
...
::callout{icon="i-simple-icons-cloudflare" to="https://developers.cloudflare.com/api/resources/zones/subresources/settings/"}
View this operation on the Cloudflare API Reference
::
...
- [Zaraz](/client/zones/settings/zaraz)
- [Google Tag Gateway](/client/zones/settings/google-tag-gateway)
