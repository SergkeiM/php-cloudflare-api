---
title: Cache Reserve
description: "Cache Reserve stores cacheable files in Cloudflare's persistent object storage, so they survive eviction from the edge cache. It requires a paid R2 subscription."
navigation:
    title: Cache Reserve
---
...
params:
  ...
  - name: "enabled"
    type: "bool"
    required: true
    description: "Whether Cache Reserve is enabled."
---
::
